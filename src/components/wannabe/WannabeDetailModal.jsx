...
const WannabeDetailModal = ({open, handleClose, roleModels, activeStep}) => {
    ...
    let description = ""
        ...
        case 7:
            bodyshape = "역삼각 체형"
            gender="여성"
            description = "역삼각 체형은 공효진의 체형에 해당해요 -- 1.같은 굵기의 몸통 2.매우 넓은 어깨 3.짧은 팔 4.보통의엉덩이길이"
            break;
        case 8:
            bodyshape = "큰 삼각 체형"
            gender="여성"
            description = "큰 삼각 체형은 김태희의 체형에 해당해요 -- 1.굵은 몸통 2. 보통의 어깨너비 3.긴 팔 4.긴 총길이 5.보통의 엉덩이길이"
            break;
        case 9:
            bodyshape = "사각 체형"
            gender="여성"
